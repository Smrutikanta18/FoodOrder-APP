  ...
  <head>
    ...
    <style>
        @media (max-width: 768px) {
            ...
            .ms-auto {
                margin-left: 0; /* Remove left margin for buttons on small screens */
        ...
        <div class="container">
          <div class="page-inner">
            ...
            <div class="container mt-4">
                   <div class="row mb-4">
                       <!-- Left side: Banner Image heading -->
                       <div class="col-md-6 d-flex align-items-center">
                           <h1 class="mb-0">Banner Images</h1>
                       </div>
                        <div class="col-md-6 d-flex justify-content-end align-items-center">
                                   <a href="NewBanner.jsp" class="btn btn-primary"><i class="fas fa-plus"></i>  Add New Banner</a>
                               </div>
                   </div>
                   ...
                   <div class="row">
                       ...
                       <div class="col-md-12 mb-4">
                           <div class="d-flex align-items-center border p-3 rounded">
                               <!-- Display ID and image -->

                               <img src="images/<%= banner.getImage() %>" class="img-thumbnail me-3" style="max-height: 100px;" alt="Banner Image">
                               <div class="me-3">
                                                                   <%= banner.getDesc() %>
                                                              </div>
                               <!-- Edit and Delete buttons -->
                               <div class="ms-auto">
                                   <a href="editbanner?id=<%= banner.getId() %>" class="btn btn-warning btn-sm me-2"><i class="fas fa-edit"></i></a>
                                   <a href="deleteBanner?id=<%= banner.getId() %>&image=<%= banner.getImage() %>" class="btn btn-danger btn-sm me-2"><i class="fas fa-trash"></i></a>
                               </div>
                           </div>
                       </div>
                       <%
