	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="contact1" class="nav-link">Contact</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="welcome">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Contact <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
			...
			<form id="changePasswordForm">
              ...
              <div class="form-group">
                <button type="button" onclick="editPassword()" class="btn btn-primary py-3 px-5">Send Massage</button>
              </div>
            </form>
					</div>
