          ...
          <div class="page-inner">
            ...
            >
              <div>
                ...
                <h6 class="op-7 mb-2">Edit Banner</h6>
              </div>
            </div>
                         ...
                         <div class="col-md-8 offset-md-2">
                             <div class="card shadow-lg">
                                 ...
                                 <div class="card-body">
                                     ...
                                     <form action="editbannerimage" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="imageId" value="<%= request.getAttribute("id") %>">
                                         ...
                                         <div class="mb-3">
                                              <label for="description" class="form-label">Description</label>
                                                      <input type="text" class="form-control" id="description" name="desc" value="<%= request.getAttribute("desc") %>">
                                         </div>
