        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">Instagram Images</h3>
            ...
            <div class="container mt-4">
                   <div class="row mb-4">
                       ...
                       <div class="col-md-6 d-flex align-items-center">
                           <h1 class="mb-0">Instagram Images</h1>
                       </div>
                   </div>
                   ...
                   <div class="row">
                       <%
                           List<image> instagramImage = (List<image>) request.getAttribute("instagramImage");
                           if (instagramImage != null && !instagramImage.isEmpty()) {
                               for (image banner : instagramImage) {
                       %>
                       <div class="col-md-12 mb-4">
                           <div class="d-flex align-items-center border p-3 rounded">
                               ...
                               <div class="ms-auto">
                                   <a href="editInsta?id=<%= banner.getId() %>" class="btn btn-warning btn-sm me-2">Edit</a>
                               </div>
                           </div>
                       </div>
                       <%
                       ...
                       %>
                       <p>No instagram images available.</p>
                       <% } %>
                   </div>
               </div>
