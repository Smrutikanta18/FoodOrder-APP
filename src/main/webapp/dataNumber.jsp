        ...
        <div class="container">
            <div class="page-inner">
                <div class="page-header">
                    <h3 class="fw-bold mb-3">Experience Data</h3>
                ...
                <div class="experience-container">
                    <div class="row mb-4">
                        <div class="col-md-6 d-flex align-items-center">
                            <h1 class="experience-header">Experience Data</h1>
                        </div>
                    ...
                    <div class="row experience-content">
                        <!-- Image Section -->
                        <div class="col-md-4 experience-image">
                            <img src="images/<%= request.getAttribute("image") %>" class="img-fluid rounded" alt="Experience Image">
                        </div>

                        <!-- Experience Data Section -->
                        <div class="col-md-8 experience-data">
                            <div>
                                <strong>Experience:</strong>
                                <p><%= request.getAttribute("experience") %> years</p>
                            </div>
                            <div>
                                <strong>Customers Served:</strong>
                                <p><%= request.getAttribute("customers") %></p>
                            </div>
                            <div>
                                <strong>Menus Available:</strong>
                                <p><%= request.getAttribute("menus") %></p>
                            </div>
                            <div>
                                <strong>Staff Members:</strong>
                                <p><%= request.getAttribute("staffs") %></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="experience-buttons">
                        <a href="editExperience.jsp?id=<%= request.getAttribute("id") %>" class="btn btn-warning btn-sm me-2">
