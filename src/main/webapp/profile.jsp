          ...
          <div class="page-inner">
            ...
            >
              <div>
                ...
                <h6 class="op-7 mb-2">Admin Profile</h6>
              </div>
            </div>
             <div class="container mt-5">
                    <div class="card">
                        <div class="card-body text-center">
                            <!-- Profile Image -->
                            <img src="http://localhost:8080/untitled/images/<%= request.getAttribute("image") %>" alt="Profile Image" class="rounded-circle mb-3" width="150" height="150">

                            <!-- Profile Information -->
                            <h3 class="card-title"><%= request.getAttribute("firstname") %> <%= request.getAttribute("lastname") %></h3>
                            <p class="card-text text-muted">Email: <%= request.getAttribute("email") %></p>
                            <p class="card-text text-muted">Phone: <%= request.getAttribute("phone") %></p>
