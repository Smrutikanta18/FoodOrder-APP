<%@ page import="java.sql.*, java.util.ArrayList, java.util.List, model.Chef" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <style>
        ...
        .form-card {
            ...
            border-radius: 10px;
            padding: 20px;
            box-shadow: 0px 6px 20px rgba(0, 0, 0, 0.1); /* Soft shadow for depth */
            border: none;
        }
        .hello {
                                   ...
                                   <div class="card-body">
                                       ...
                                       <input type="hidden" name="id" value="${id}">
                                           ...
                                           <div class="form-group mb-4">
                                               ...
                                               <input type="text" class="form-control" id="name" value="${name}" name="name" placeholder="Enter chef's name" >
                                           </div>
                                           <div class="form-group mb-4">
                                               <label for="profile" class="form-label">Profile</label>
                                               <input type="text" class="form-control" id="profile" value="${profile}" name="profile" placeholder="Enter chef's profile" >
                                           </div>

                                           <div class="form-group mb-4">
                                               <label for="image" class="form-label">Image</label>
                                               <div class="hello">
                                                   <img src="http://localhost:8080/untitled/images/${images}" alt="${name}" class="current-image">
                                               </div>
                                               <input type="file" class="form-control-file"  id="image" name="image" value="${images}">
                                           </div>
                                           <div class="form-group mb-4">
                                               <label for="desc" class="form-label">Description</label>
                                               <textarea class="form-control" id="desc" name="desc" rows="3" placeholder="Enter chef's description" >${desc}</textarea>
                                           </div>
                                           <button type="submit" class="btn btn-primary btn-block">Edit Chef</button>
                                       </form>
                                   </div>
                               </div>
                           </div>
