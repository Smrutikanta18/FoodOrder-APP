                  ...
                  <ul class="nav nav-secondary">
                    ...
                    <li class="nav-item">
                                          ...
                                          <div class="collapse" id="maps">
                                            <ul class="nav nav-collapse">
                                              <li>
                                                <a href="http://localhost:8080/untitled/">
          ...
          <div class="page-inner">
            ...
            >
              <div>
                ...
                <h6 class="op-7 mb-2">Edit Admin Profile</h6>
              </div>
            </div>
             <div class="container mt-5">
                     <h2 class="mb-4">Edit Profile</h2>
                     <form action="profileUpdated" method="post" enctype="multipart/form-data">
                         <div class="row mb-3">
                             <div class="col-md-6">
                                 <label for="firstname" class="form-label">First Name</label>
                                 <input type="text" class="form-control" id="firstname" name="firstname" value="<%= request.getAttribute("firstname") %>" required>
                             </div>
                             <div class="col-md-6">
                                 <label for="lastname" class="form-label">Last Name</label>
                                 <input type="text" class="form-control" id="lastname" name="lastname" value="<%= request.getAttribute("lastname") %>" required>
                             </div>
                         </div>
                         <div class="mb-3">
                         ...
                         <div class="mb-3">
                             ...
                             <input type="text" class="form-control" id="phone" name="phone" value="<%= request.getAttribute("phone") %>">
                         </div>
                         <div class="mb-3">
                             <label for="image" class="form-label">Profile Image</label>
                             <input type="file" class="form-control" id="image" name="image" value="<%= request.getAttribute("image") %>>
                         </div>
                         <br>
                         <div class="mb-3">
