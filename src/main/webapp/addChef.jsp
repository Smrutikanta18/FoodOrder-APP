        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">Add Chef</h3>
              <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                  <a href="#">Add Chef data</a>
                </li>
              </ul>
            </div>
           <div class="container">
               <h2 class="my-4">Add Chef Data</h2>
               <div class="row">
                   <div class="col-md-12">
                                   ...
                                   <div class="card-body">
                                       <form action="addchef" method="post" enctype="multipart/form-data">
                                           ...
                                           <div class="form-group mb-4">
                                               ...
                                               <input type="text" class="form-control" id="profile" name="profile" placeholder="Enter chef's profile" required>
                                           </div>
                                           <div class="form-group mb-4">
                                           ...
                                           <div class="form-group mb-4">
                                               ...
                                               <textarea class="form-control" id="desc" name="desc" rows="4" placeholder="Enter chef's description" required></textarea>
                                           </div>
