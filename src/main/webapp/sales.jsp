        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">Add sales amount</h3>
              <ul class="breadcrumbs mb-3">
                <li class="separator">
                  <i class="icon-arrow-right"></i>
                </li>
                <li class="nav-item">
                  <a href="#">sales amount</a>
                </li>
              </ul>
            </div>
            <%
            ...
            %>
             ...
             <div class="container">
                     <div class="sales-form-container shadow-lg">
                         <div class="sales-form-header">
                             <h3>Add Sales Amount</h3>
                         </div>
                         <form action="addAmount" method="post">
                             ...
                             <div class="d-grid gap-2">
                                 <button type="submit" class="sales-btn-custom">Add</button>
                             </div>
                         </form>
                     </div>
                 </div>
